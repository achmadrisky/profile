          ...
          <div className="hero-content flex-col lg:flex-row">
            ...
            <div className="bg-gray-200 p-10 rounded-2xl shadow-2xs flex flex-col lg:flex-row gap-10 items-start">
              <div className="flex-1 order-1 lg:order-none">
                ...
                <p className="text-gray-500 mb-6">My name is Achmad Risky a content creator and web developer from Indonesia I have rich experience in website design, photoshop, video editing, and customization. Also i am good at Photography.</p>
